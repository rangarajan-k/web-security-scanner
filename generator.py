...
# Check if login is POST to self, works in 2.7.12
...
try:
	rsp = urllib2.urlopen(url, context=ctx, timeout=4)
...
for line in content.splitlines():
	if "form" and url.split('/')[-1] in line.lower():
		if "post" in line.lower():
			notPost = False

if notPost:
	print "POTENTIAL PROBLEM IN LOGIN ROUTINE, EDIT MANUALLY"
